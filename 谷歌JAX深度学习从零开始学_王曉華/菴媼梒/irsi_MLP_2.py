...
rng = random.PRNGKey(17)
a0 = random.normal(rng, shape=[4,4])
b0 = random.normal(rng, shape=(4,))

a1 = random.normal(rng, shape=[4,8])
b1 = random.normal(rng, shape=(8,))

a2 = random.normal(rng, shape=[8,10])
b2= random.normal(rng, shape=(10,))

params = [a0, b0, a1, b1,a2,b2]
#x = loss_mlp(params,iris_data,iris_target)
...
#params = jnp.load("mlp_params.npy",allow_pickle=True)
predict_result = mlp(iris_data, params)
predicted_class = jnp.argmax(predict_result, axis=1)
